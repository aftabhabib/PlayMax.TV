...
import hkapps.playmxtv.Fragments.PlaybackOverlayFragment;
...
public class PlaybackOverlayActivity extends Activity implements
     ...
     */
    public void onFragmentPlayPause(Ficha.FichaReproducible movie, int position, Boolean playPause) {
        mVideoView.setVideoPath(movie.getDirectUrl());
    ...
    private void updatePlaybackState(int position) {
        PlaybackState.Builder stateBuilder = new PlaybackState.Builder().setActions(PlaybackState.ACTION_PLAY_PAUSE);
